  ...
  // ── 3. 学时证明（蓝色清爽） ──
  {
    ...
    canvas: {
      ...
      elements: [
        ...
        { id: 'p3_body', type: 'variable-text', x: 150, y: 240, width: 823, height: 110, name: '正文', props: { template: '兹证明 {{studentName}} 于 {{startDate}} 至 {{endDate}} 期间参加 {{courseName}} 培训，累计完成 {{totalHours}} 学时，特此证明。', fontSize: 21, fontFamily: 'SimSun, serif', color: '#333', lineHeight: 1.9 } },
        { id: 'p3_div', type: 'divider', x: 150, y: 420, width: 823, height: 0, name: '分割线', layer: 'design', props: { style: 'solid', color: '#BBDEFB', thickness: 2 } },
        { id: 'p3_id', type: 'variable-text', x: 150, y: 460, width: 500, height: 26, name: '身份证号', props: { template: '身份证号：{{idCardMasked}}', fontSize: 14, fontFamily: 'SimSun, serif', color: '#666', textAlign: 'left' } },
        { id: 'p3_org', type: 'variable-text', x: 150, y: 640, width: 400, height: 30, name: '出具机构', props: { template: '{{orgName}}', fontSize: 18, fontFamily: 'SimSun, serif', color: '#444', textAlign: 'left' } },
        ...
        { id: 'p3_qr', type: 'qrcode', x: 940, y: 540, width: 100, height: 100, name: '验证二维码', props: { dataTemplate: 'https://verify.example.com/{{certificateNo}}', label: '扫码核验', labelFontSize: 10 } },
      ],
    },
  },
