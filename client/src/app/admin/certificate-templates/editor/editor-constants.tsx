...
export const DEFAULT_DATA: TemplateData = { studentName: '张三', courseName: '人工智能应用', certificateNo: 'CERT-2026-001', issueDate: '2026-07-30', orgName: '示例机构' };
...
/** 变量芯片渲染用的中文标签表 */
export const VAR_LABELS: Record<string, string> = { studentName: '姓名', courseName: '课程', certificateNo: '编号', issueDate: '日期', orgName: '机构', idCard: '身份证', idCardMasked: '身份证(脱敏)', totalHours: '学时', startDate: '开始', endDate: '结束', verificationCode: '验证码' };
