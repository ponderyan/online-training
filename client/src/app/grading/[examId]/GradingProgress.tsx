  ...
  return (
    <div className="space-y-4">
      ...
      {questionStats.length > 0 && (
        <div className="card p-5">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--ink-700)' }}>📊 每题统计分析</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr style={{ borderBottom: '2px solid var(--ink-100)' }}>
                  <th className="text-left py-2 px-2" style={{ color: 'var(--ink-400)' }}>题目</th>
                  <th className="text-center py-2 px-2" style={{ color: 'var(--ink-400)' }}>满分</th>
                  <th className="text-center py-2 px-2" style={{ color: 'var(--ink-400)' }}>平均分</th>
                  <th className="text-center py-2 px-2" style={{ color: 'var(--ink-400)' }}>得分率</th>
                  <th className="text-center py-2 px-2" style={{ color: 'var(--ink-400)' }}>最高/最低</th>
                  <th className="text-center py-2 px-2" style={{ color: 'var(--ink-400)' }}>正确率</th>
                  <th className="text-left py-2 px-2" style={{ color: 'var(--ink-400)' }}>分布</th>
                </tr>
              </thead>
              <tbody>
                {questionStats.map((qs: any) => (
                  <tr key={qs.pqId} style={{ borderBottom: '1px solid var(--ink-100)' }}>
                    <td className="py-2.5 px-2">
                      ...
                      <span style={{ color: 'var(--ink-600)' }}>{qs.content}</span>
                    </td>
                    <td className="text-center py-2.5 px-2 num" style={{ color: 'var(--ink-500)' }}>{qs.maxScore}</td>
                    ...
                    <td className="text-center py-2.5 px-2 num" style={{ color: 'var(--ink-500)' }}>{qs.maxScoreGot}/{qs.minScoreGot}</td>
                    <td className="text-center py-2.5 px-2 num" style={{ color: 'var(--ink-400)' }}>{qs.correctRate !== null ? `${qs.correctRate}%` : '-'}</td>
                    <td className="py-2.5 px-2">
