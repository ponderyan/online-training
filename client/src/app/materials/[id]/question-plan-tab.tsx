  ...
  return (
    <div>
      ...
      {materialStatus === 'STRUCTURED' && plans.length === 0 && !showNewForm && (
        <div className="p-4 mb-4 rounded-lg text-sm bg-[var(--cyan-glow)] text-[var(--cyan)]" style={{   border: '1px solid var(--cyan)' }}>
      ...
      {materialStatus !== 'STRUCTURED' && materialStatus !== 'GENERATED' && materialStatus !== 'REVIEWING' && materialStatus !== 'COMPLETED' && (
        <div className="p-4 mb-4 rounded-lg text-sm bg-[var(--fox-pale)] text-[var(--fox-dark)]" style={{   border: '1px solid var(--fox-glow)' }}>
